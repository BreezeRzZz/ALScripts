...
function Equipment.GetAttributes(arg_7_0)
	...
	for iter_7_0 = 1, 3 do
		...
		var_7_0[iter_7_0] = var_7_1 ~= nil and {
			type = var_7_1,
...
function Equipment.GetInfoTrans(arg_13_0, arg_13_1)
	...
	elseif arg_13_0.type == AttributeType.AntiSiren then
...
local function var_0_5(arg_14_0)
	...
	if string.match(arg_14_0, var_14_0) then
...
function Equipment.GetWeaponPageInfo(arg_20_0, arg_20_1, arg_20_2)
	...
	for iter_20_0, iter_20_1 in ipairs(var_20_1.exhibition_list) do
...
function Equipment.IsMatchKey(self, key)
	local equipName = pg.equip_data_statistics[self.configId].name
	local nameList = {
		self:getConfig("name"),
		equipName
	}

	return EquipmentTools.IsMatchKey(nameList, key)
end
