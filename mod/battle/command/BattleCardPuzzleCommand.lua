...
function var_0_3.onAddUnit(arg_18_0, arg_18_1)
	...
	if var_18_0 == var_0_0.Battle.BattleConst.UnitType.ENEMY_UNIT or var_18_0 == var_0_0.Battle.BattleConst.UnitType.BOSS_UNIT then
...
function var_0_3.onWillDie(arg_24_0, arg_24_1)
	...
	if var_24_0:IsBoss() and not var_24_1 then
