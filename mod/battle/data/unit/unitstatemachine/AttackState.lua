...
var_0_0.Battle.AttackState = class("AttackState", var_0_0.Battle.IUnitState)
var_0_0.Battle.AttackState.__name = "AttackState"

local var_0_2 = var_0_0.Battle.AttackState
